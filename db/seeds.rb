...
Flower.create(name: 'Dunno2',description: 'Dunno2 dunno this!').image.attach(io: File.open('app/assets/images/ekko.jpg'),filename: 'flw1')
...
Flower.create(name: 'Dunno4',description: 'Dunno4 dunno this!').image.attach(io: File.open('app/assets/images/ekko.jpg'),filename: 'flw1')
